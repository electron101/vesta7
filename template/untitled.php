...
<form class="form-horizontal" id="ReportOtdelForm" role="form">
	...
	<small>
	  ...
	  <div class="input-group date input-append" id="datetimepicker_start">
	    ...
	    <input type="text"  id="date_start" name="date_start" class="form-control input-sm" required>
		</input>
	...
	<div class="input-group date" id="datetimepicker_end">
	    ...
	    <input type="text" id="date_end" name="date_end" class="form-control input-sm" required>
		</input>
		<span class="glyphicon form-control-feedback"></span>
	  </div>
	  </div>
	...
	<div class="form-group">
		<div class="col-md-12">
			<button class="btn btn-info btn-block btn-sm" 
				id="main_stat_make"
				type="submit"
				onclick="show_report(this.value)" >Сформировать
			</button>
		</div>
	</div>
</form>
...
{
	var str = $('#ReportOtdelForm').serialize();
	...
	$.ajax(
	{
		...
		{
			// alert(msg);
			// $('#date_start').val(msg.date_end);
			// $('#date_end').val(msg.date_start);
		},
